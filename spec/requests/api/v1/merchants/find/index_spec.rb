...
RSpec.describe 'As a visitor', type: :request do
  before(:each) do
    @m_1 = create(:merchant, name: 'Common Name')
    @m_2 = create(:merchant, name: 'Common Name')
    @m_3 = create(:merchant, created_at: Time.zone.parse('2020-01-10'))
    @m_4 = create(:merchant, created_at: Time.zone.parse('2020-01-10'))
    @m_5 = create(:merchant, updated_at: Time.zone.parse('2020-01-15'))
    @m_6 = create(:merchant, updated_at: Time.zone.parse('2020-01-15'))
    @m_7 = create(:merchant, updated_at: Time.zone.parse('2020-01-15'))
    @m_8 = create(:merchant)
  end
