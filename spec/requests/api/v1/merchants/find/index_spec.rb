  ...
  describe 'when I send a get request to the merchants find index path' do
    describe 'by their name attribute (case-insensitive)' do
      ...
      it 'I get a JSON response with attributes of all matching merchants' do
        ...
        expect(@hash['data'][0]['id']).to eq(@merchant_1.id.to_s)
        ...
        expect(@hash['data'][0]['attributes']['name']).to eq(@merchant_1.name.to_s)
        expect(@hash['data'][0]['attributes']['id']).to eq(@merchant_1.id)

        expect(@hash['data'][1]['id']).to eq(@merchant_2.id.to_s)
        ...
        expect(@hash['data'][1]['attributes']['name']).to eq(@merchant_2.name.to_s)
        ...
        expect(@hash.to_s).not_to include(@merchant_5.name.to_s)
        expect(@hash.to_s).not_to include(@merchant_6.name.to_s)
        expect(@hash.to_s).not_to include(@merchant_7.name.to_s)
        expect(@hash.to_s).not_to include(@merchant_8.name.to_s)
      end
    end
    ...
    describe 'by their id attribute' do
      ...
      it 'I get a JSON response with attributes of all matching merchants' do
        ...
        expect(@hash['data'][0]['id']).to eq(@merchant_8.id.to_s)
        expect(@hash['data'][0]['type']).to eq('merchant')
        expect(@hash['data'][0]['attributes'].class).to eq(Hash)
        expect(@hash['data'][0]['attributes'].length).to eq(2)
        expect(@hash['data'][0]['attributes']['name']).to eq(@merchant_8.name.to_s)
    ...
    describe 'by their created_at attribute' do
      ...
      it 'I get a JSON response with attributes of all matching merchants' do
        ...
        expect(@hash['data'][0]['id']).to eq(@merchant_3.id.to_s)
        expect(@hash['data'][0]['type']).to eq('merchant')
        expect(@hash['data'][0]['attributes'].class).to eq(Hash)
        expect(@hash['data'][0]['attributes'].length).to eq(2)
        expect(@hash['data'][0]['attributes']['name']).to eq(@merchant_3.name.to_s)
        expect(@hash['data'][0]['attributes']['id']).to eq(@merchant_3.id)

        expect(@hash['data'][1]['id']).to eq(@merchant_4.id.to_s)
        expect(@hash['data'][1]['type']).to eq('merchant')
        expect(@hash['data'][1]['attributes'].class).to eq(Hash)
        expect(@hash['data'][1]['attributes'].length).to eq(2)
        expect(@hash['data'][1]['attributes']['name']).to eq(@merchant_4.name.to_s)
    ...
    describe 'by their updated_at attribute' do
      ...
      it 'I get a JSON response with attributes of all matching merchants' do
        ...
        expect(@hash['data'][2]['id']).to eq(@merchant_7.id.to_s)
        ...
        expect(@hash['data'][2]['attributes']['name']).to eq(@merchant_7.name.to_s)
